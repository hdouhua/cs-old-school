...
<img alt="service-" src="https://static001.geekbang.org/resource/image/0f/64/0f74ae3a71a6a661376698e481903d64.jpg" width="50%"/><br/>
...
1. 创建 Service 对象
   ...
   ```shell
   k apply -f ngx-conf.yml
   k apply -f ngx-dep.yml
   k apply -f ngx-svc.yml
   ```
...
```shell
k exec -it ngx-dep-6796688696-dp222 -- sh
...
```shell
k delete pod ngx-dep-6796688696-wmgvb
...
<img alt="service-nodeport" src="https://static001.geekbang.org/resource/image/fy/4a/fyyebea67e4471aa53cb3a0e8ebe624a.jpg?wh=1920x940" width="70%"/><br/>
